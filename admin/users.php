...
?>
	...
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<h3 class="text-center bg-light shadow-lg mt-2 mb-4">All User</h3>
				<a href="add_user.php" class="btn btn-primary mt-3 mb-3 post-link" style="margin-left: 40px; margin-right: 300px; width: 200px;">ADD New</a>
